...
export default class extends Controller {
  ...
  dropBox() {
    ...
    if ( this.element.id == currentPlayer().dom_id ) {
      ...
      this.element.insertAdjacentHTML('beforeend', `<div class='w-20 h-20 bg-${color}' data-controller='box' data-box-create-url-value='${createBoxUrlWithColor}' data-box-delete-url-value='${this.deleteBoxUrlValue}'></div>`)
    }
  }
}
